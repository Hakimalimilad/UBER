...
const Sidebar = ({
  ...
  const [isSidebarLockedOpen, setIsSidebarLockedOpen] =
  ...
  return (
    <div className="sidebar-container">
      ...
      <nav
        ...
        } ${isSidebarLockedOpen ? "lg:w-64" : "lg:w-14 lg:hover:w-64"}`}
      ...
      >
        ...
        <div
          className="h-screen overflow-y-auto overflow-x-hidden flex flex-col"
        ...
        >
            ...
            {isOpen || isDesktopHovered || isSidebarLockedOpen ? (
              <div className="text-center relative">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  {/* Top area particles */}
                  <div
                    className="absolute -top-1 -left-1 w-1 h-1 bg-slate-400/30 rounded-full animate-pulse"
                    style={{ animationDuration: "3s" }}
                  ></div>
                  <div
                    className="absolute -top-1 right-2 w-1 h-1 bg-indigo-400/25 rounded-full animate-bounce"
                    style={{ animationDuration: "4s", animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="absolute top-1 left-3 w-0.5 h-0.5 bg-slate-300/20 rounded-full animate-pulse"
                    style={{ animationDuration: "2.5s", animationDelay: "1s" }}
                  ></div>

                  {/* Side particles */}
                  <div
                    className="absolute top-3 -left-2 w-1 h-1 bg-indigo-300/30 rounded-full animate-bounce"
                    style={{
                  ...
                  ></div>
                  <div
                    className="absolute top-4 right-0 w-0.5 h-0.5 bg-slate-400/25 rounded-full animate-pulse"
                    style={{
                  ...
                  <div
                    className="absolute -bottom-1 -left-1 w-1 h-1 bg-purple-400/20 rounded-full animate-bounce"
                    style={{
                  ...
                  ></div>
                  <div
                    className="absolute -bottom-1 right-1 w-0.5 h-0.5 bg-slate-300/25 rounded-full animate-pulse"
                    style={{
                  ...
                  ></div>
                  <div
                    className="absolute bottom-2 left-2 w-0.5 h-0.5 bg-indigo-400/20 rounded-full animate-bounce"
                    style={{
                ...
                <h1
                  className="text-xl font-bold bg-gradient-to-r from-white via-purple-200 to-indigo-200 bg-clip-text text-transparent mb-1 relative z-10"
                  style={{
              ...
              <div className="hidden lg:flex items-center justify-center">
                <Car
                  size={24}
                  className="text-slate-300/80 hover:text-indigo-400 transition-all duration-300 drop-shadow-lg"
                  strokeWidth={1.5}
                />
                {/* Star particles distributed along collapsed sidebar */}
                <div className="absolute inset-0 pointer-events-none">
                  <div
                    className="absolute top-12 left-1/2 -translate-x-1/2 w-1 h-1 bg-slate-400/25 rounded-full animate-pulse"
                    style={{ animationDuration: "4s" }}
                  ></div>
                  <div
                    className="absolute top-20 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-indigo-400/20 rounded-full animate-bounce"
                    style={{ animationDuration: "3s", animationDelay: "1s" }}
                  ></div>
                  <div
                    className="absolute top-32 left-1/2 -translate-x-1/2 w-1 h-1 bg-slate-300/30 rounded-full animate-pulse"
                    style={{ animationDuration: "5s", animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="absolute top-44 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-indigo-300/25 rounded-full animate-bounce"
                    style={{ animationDuration: "3.5s", animationDelay: "2s" }}
                  ></div>
                  <div
                    className="absolute top-56 left-1/2 -translate-x-1/2 w-1 h-1 bg-purple-400/20 rounded-full animate-pulse"
                    style={{
                      animationDuration: "4.5s",
                      animationDelay: "1.5s",
                    }}
                  ></div>
                  <div
                    className="absolute top-72 left-1/2 -translate-x-1/2 w-0.5 h-0.5 bg-slate-400/20 rounded-full animate-bounce"
                    style={{
                      animationDuration: "2.8s",
                      animationDelay: "0.8s",
                    }}
                  ></div>
                  <div
                    className="absolute top-80 left-1/2 -translate-x-1/2 w-1 h-1 bg-indigo-400/25 rounded-full animate-pulse"
                    style={{
          ...
          <div className="flex-1 px-2 py-3">
            ...
            <div className="mb-4 group/section">
              <div
                className={`flex items-center gap-2 px-2 mb-2 group-hover/section:px-3 transition-all duration-300 ${
                  isOpen || isDesktopHovered || isSidebarLockedOpen
                    ? "opacity-100"
                    : "lg:opacity-0"
                }`}
                ...
                {items.slice(0, 3).map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`relative z-10 whitespace-nowrap transition-all duration-300 ease-in-out ${
                          isOpen || isDesktopHovered || isSidebarLockedOpen
                ...
                {items.slice(3).map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`relative z-10 whitespace-nowrap flex items-center gap-2 transition-all duration-300 ease-in-out ${
                          isOpen || isDesktopHovered || isSidebarLockedOpen
          ...
          >
            <div
              className={`border-t border-slate-700/30 group-hover/sidebar:border-slate-600/50 pt-6 pb-6 space-y-6 transition-colors duration-500 ${
                isOpen || isDesktopHovered || isSidebarLockedOpen
                  ? ""
                  : "border-none pt-4 pb-4"
              }`}
            >
              ...
              {isOpen || isDesktopHovered || isSidebarLockedOpen ? (
                ...
                >
                  <LogOut
                    size={16}
                    className="text-slate-300 group-hover/logout:text-red-400 group-hover/logout:scale-110 transition-all duration-300 relative z-10"
                  />
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div className="absolute inset-0">
              {/* Large Stars */}
              <div
                className="absolute top-10 left-6 w-1 h-1 bg-white rounded-full animate-pulse opacity-80"
                style={{ animationDelay: "0s", animationDuration: "3s" }}
              ></div>
              <div
                className="absolute top-20 right-8 w-0.5 h-0.5 bg-blue-200 rounded-full animate-pulse opacity-60"
                style={{ animationDelay: "1s", animationDuration: "4s" }}
              ></div>
              <div
                className="absolute top-32 left-12 w-1.5 h-1.5 bg-indigo-300 rounded-full animate-pulse opacity-70"
                style={{ animationDelay: "2s", animationDuration: "2.5s" }}
              ></div>
              <div
                className="absolute top-48 right-4 w-0.5 h-0.5 bg-purple-200 rounded-full animate-pulse opacity-50"
                style={{ animationDelay: "0.5s", animationDuration: "3.5s" }}
              ></div>
              <div
                className="absolute top-64 left-8 w-1 h-1 bg-cyan-200 rounded-full animate-pulse opacity-60"
                style={{ animationDelay: "1.5s", animationDuration: "4.5s" }}
              ></div>

              {/* Medium Stars */}
              <div
                className="absolute top-80 right-10 w-0.5 h-0.5 bg-white rounded-full animate-pulse opacity-40"
                style={{ animationDelay: "3s", animationDuration: "2s" }}
              ></div>
              <div
                className="absolute top-96 left-4 w-1 h-1 bg-indigo-200 rounded-full animate-pulse opacity-50"
                style={{ animationDelay: "2.5s", animationDuration: "3s" }}
              ></div>
              <div
                className="absolute bottom-32 right-6 w-0.5 h-0.5 bg-purple-300 rounded-full animate-pulse opacity-60"
                style={{ animationDelay: "1s", animationDuration: "4s" }}
              ></div>
              <div
                className="absolute bottom-48 left-10 w-1 h-1 bg-blue-300 rounded-full animate-pulse opacity-45"
                style={{ animationDelay: "3.5s", animationDuration: "2.8s" }}
              ></div>

              {/* Small Twinkling Stars */}
              <div
                className="absolute top-16 left-3 w-0.5 h-0.5 bg-white rounded-full animate-ping opacity-30"
                style={{ animationDelay: "0s", animationDuration: "5s" }}
              ></div>
              <div
                className="absolute top-40 right-3 w-0.5 h-0.5 bg-cyan-100 rounded-full animate-ping opacity-25"
                style={{ animationDelay: "2s", animationDuration: "6s" }}
              ></div>
              <div
                className="absolute bottom-20 left-6 w-0.5 h-0.5 bg-indigo-100 rounded-full animate-ping opacity-35"
            ...
            <div className="absolute inset-0 opacity-20">
              {/* Floating Car Emoji */}
              <div
                className="absolute top-24 right-2 text-lg animate-bounce opacity-40"
                style={{ animationDelay: "1s", animationDuration: "8s" }}
              >
                🚗
              </div>
              <div
                className="absolute bottom-40 left-2 text-sm animate-bounce opacity-30"
                style={{ animationDelay: "3s", animationDuration: "10s" }}
              >
                🗺️
              </div>
              <div
                className="absolute top-60 right-1 text-xs animate-bounce opacity-25"

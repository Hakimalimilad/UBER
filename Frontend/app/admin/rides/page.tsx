...
export default function AdminRides() {
  ...
  const filteredRides = allRides.filter((ride) => {
    ...
    const studentName = (ride.student || ride.student_name || "").toString();
    const driverName = (ride.driver || ride.driver_name || "").toString();
    const pickup = (ride.pickup || ride.pickup_location || "").toString();
    const dropoff = (ride.dropoff || ride.dropoff_location || "").toString();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 bg-gradient-to-br from-red-100 to-rose-100 rounded-lg">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 bg-gradient-to-br from-yellow-100 to-amber-100 rounded-lg">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by student name, driver name, pickup, or destination..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-500 text-gray-900"
                />
              </div>
            </div>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-gray-900">
                              {ride.student || ride.student_name || "N/A"}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm font-medium text-gray-900">
                              {ride.pickup || ride.pickup_location || "N/A"}
                            </p>
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <p className="text-sm font-medium text-gray-900">
                              {ride.dropoff || ride.dropoff_location || "N/A"}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-6 text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{ride.date || ride.pickup_time || "N/A"}</span>
                        </div>
                        <div className="flex items-center gap-2">

...
import { Settings, Lock, Shield, User, Building2, Mail, Camera, Upload, Trash2, AlertTriangle } from 'lucide-react';
...
const SettingsPage = () => {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setProfileData({
          ...profileData,
          profilePicture: mappedUser.profilePicture || profileData.profilePicture,
        });
      ...
      setProfileMsg('Network error. Please check your connection and try again.');
    } finally {
      setIsUpdatingProfile(false);
    }
  };
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPasswordMsg(data.error || 'Failed to update password. Please check your current password.');
      }
    } catch (error: any) {
      console.error('Password change error:', error);
      setPasswordMsg('Network error. Please check your connection and try again.');
    } finally {
      setIsChangingPassword(false);
    }
  };
  ...
  const handleProfilePictureUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      setProfileMsg('Profile picture updated successfully! Remember to save your profile to persist changes.');
    };
    ...
    <MainLayout>
      <div className="w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-8 max-w-none sm:max-w-4xl sm:mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">Manage your profile, security, and integrations</p>
        </div>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-6">
                ...
                {profileData.user_type === 'driver' && (
                  <div className="pt-4 border-t border-gray-200">
                    <h3 className="text-base font-semibold text-gray-900 mb-4">Driver Information</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setProfileData({ ...profileData, vehicle_plate: e.target.value })}
                          disabled={isUpdatingProfile}
                        />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setProfileData({ ...profileData, campus_location: e.target.value })}
                          disabled={isUpdatingProfile}
                        />
                      </div>
                    </div>

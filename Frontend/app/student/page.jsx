...
export default function StudentDashboard() {
  ...
  const handleBookRide = (rideId) => {
    alert(`Booking ride #${rideId} - This will be implemented with backend integration`);
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">Book a ride to your destination</p>
          </div>
              ...
              {availableRides.map((ride) => (
                <div key={ride.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="font-semibold text-gray-900">{ride.route}</h3>
                      <p className="text-sm text-gray-600">Driver: {ride.driver}</p>
                    </div>
                    <span className="text-lg font-bold text-indigo-600">{ride.price}</span>
                  </div>
